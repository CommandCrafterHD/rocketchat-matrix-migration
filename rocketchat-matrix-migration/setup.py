...
setup(
    ...
    url='https://github.com/sapianco/slack-matrix-migration',

    # This should be your name or the name of the organization which owns the
    # project.
    author='Sebastian Rojo',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='sebastian.rojo@sapian.com.co',  # Optional
    ...
    keywords='python docker sapian',  # Optional
    ...
    # install_requires=['pyocclient', 'PyYAML'],  # Optional
