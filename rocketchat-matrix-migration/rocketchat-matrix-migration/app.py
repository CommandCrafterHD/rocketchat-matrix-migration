...
#
#       rocketchat-matrix-migration/rocketchat-matrix-migration/app.py
...
def terminateProcess(signalNumber, frame):
    ...
    if PROMETHEUS_PUSH_GW:
        pushadd_to_gateway(PROMETHEUS_PUSH_GW, job='rocketchat-matrix-migration', registry=registry)
    sys.exit(1)
...
if __name__ == '__main__':
    ...
    try:
        with duration.time():
            log.info('Starting... rocketchat-matrix-migration')
